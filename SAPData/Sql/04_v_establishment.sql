...
FROM t_edubasealldata202604_fa7e010711 t
WHERE
    clean_int(t."typeofestablishment__code_") <> 49
    AND (t."closedate" IS NULL OR t."closedate" = '' OR TO_DATE(t."closedate", 'DD/MM/YYYY') >= '2022-09-12')
    AND (clean_int(t."phaseofeducation__code_") IN (4, 5, 7) OR (clean_int(t."phaseofeducation__code_") = 0 AND clean_int(t."typeofestablishment__code_") = 06))

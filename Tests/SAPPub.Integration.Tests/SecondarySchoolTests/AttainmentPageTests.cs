...
public class AttainmentPageTests(WebApplicationSetupFixture fixture) : BasePageTest(fixture)
{
    ...
    [InlineData("145564", 50.4, 44.1, 46.1)]
    [InlineData("147531", 49.1, 44.1, 46.1)]
    [InlineData("147894", 57.5, 44.1, 46.1)]
    [InlineData("147711", 45.8, 44.1, 46.1)]
    [InlineData("136971", 46.4, 44.1, 46.1)]
    [InlineData("137903", 46.9, 44.1, 46.1)]
    [InlineData("148109", 44.7, 44.1, 46.1)]
    [InlineData("145253", 41.5, 44.1, 46.1)]
    [InlineData("148706", 39.4, 44.1, 46.1)]
    [InlineData("138717", 48.2, 44.1, 46.1)]
    [InlineData("149962", 35.7, 44.1, 46.1)]
    [InlineData("136770", 43.9, 44.1, 46.1)]
    [InlineData("114308", 53.4, 44.1, 46.1)]
    [InlineData("137696", 45.2, 44.1, 46.1)]
    [InlineData("149251", 37.4, 44.1, 46.1)]
    [InlineData("114312", 55.2, 44.1, 46.1)]
    [InlineData("147122", 41.4, 44.1, 46.1)]
    [InlineData("136451", 52.2, 44.1, 46.1)]
    [InlineData("149739", 47.8, 44.1, 46.1)]
    [InlineData("147670", 51.5, 44.1, 46.1)]
    [InlineData("138075", 51.8, 44.1, 46.1)]
    [InlineData("137702", 46.4, 44.1, 46.1)]
    [InlineData("143583", 57.7, 44.1, 46.1)]
    [InlineData("148304", 44.5, 44.1, 46.1)]
    [InlineData("138172", 44.9, 44.1, 46.1)]
    public async Task SecondaryAcademicPerformanceProgressAndAttainment_ShowsExpectedAttainment(string urn, double expectedAttainmentSchool, double expectedAttainmentLA, double expectedAttainmentEngland)
    {
        // Arrange && Act
        ...
        Assert.Equal(expectedAttainmentLA.ToString("F1"), laAttainment8);
        ...
        Assert.Equal(expectedAttainmentEngland.ToString("F1"), englandAttainment8);
    }
    ...
    private async Task<string> GetScoreAsync(string dataTestid, string textString)
    {

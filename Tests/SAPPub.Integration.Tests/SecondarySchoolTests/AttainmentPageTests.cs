...
public class AttainmentPageTests() : BasePageTest()
{
    ...
    private async Task AssertAttainmentData(IPage Page, double expectedAttainmentSchool, double expectedAttainmentLA, double expectedAttainmentEngland)
    {
        ...
        var laAttainment8 = await Page.GetScoreFromParagraphAsync("attainment8-localauthority-and-national-card", "the local council average of");
    ...
    public async Task SecondaryAcademicPerformanceProgressAndAttainment_Current_ShowsExpectedAttainmentData(string urn, double expectedAttainmentSchool, double expectedAttainmentLA, double expectedAttainmentEngland)
    {
        ...
        // Assert
        await AssertAttainmentData(Page, expectedAttainmentSchool, expectedAttainmentLA, expectedAttainmentEngland);
    }
    ...
    private async Task AssertProgressData(IPage Page, double expectedProgressSchool, double expectedBandingLower, double expectedBandingHigher, double expectedProgressLA)
    {
        ...
        double expectedProgressLA)
    {
        ...
        // Assert
        await AssertProgressData(Page, expectedProgressSchool, expectedBandingLower, expectedBandingHigher, expectedProgressLA);
    }

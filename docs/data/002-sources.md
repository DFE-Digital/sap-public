...
The sources used as of writing are as follows:

| Dataset       | Publication / Source | CSCP Reference (On publication timetable)
|----------|----------|----------------- |
...
| national_performance_202225_API | (EES) a-level-and-other-16-to-18-results |16 to 18 performance
| sen_phase_type_ | (EES) special-educational-needs-in-england |
| links_edubasealldata.csv |" (GIAS) ""Establishment links"" in Download "|Not EES
| la_urls | (Data.gov.uk) https://www.data.gov.uk/dataset/a0abdb2c-f210-4f07-bb36-9ff553bf4a23/local-authority-services |Not EES
| grouplinks_edubaseallacademiesandfree.csv |" (GIAS) ""Academies and free school links"" in Download "|Not EES
...
| Banding_information_KS2 | Manual one-time data delivery from data ops for historical KS2 (2022/23) values | n/a
| Banding_information_KS4 | Manual one-time data delivery from data ops for historical KS4 (2022/23, 2023/24) values | n/a
| Banding_information_KS5 | Manual one-time data delivery from data ops for historical KS5 (2024/25) values | n/a
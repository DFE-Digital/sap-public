...
├── SAPPub.Core/               # Domain models and business logic
│   └── SAPPub.Core.csproj
├── SAPPub.Infrastructure/     # Data access and external services
│   ├── Data/                  # Database context (future)
│   └── SAPPub.Infrastructure.csproj
├── SAPPub.Web/               # Web application (MVC)
  ...
  "checks": [
    {
      ...
      "status": "Pass",
      "message": "SAPPub.Web is running in Production environment"
    },
    {
      "name": "StaticFiles",
      "status": "Pass",

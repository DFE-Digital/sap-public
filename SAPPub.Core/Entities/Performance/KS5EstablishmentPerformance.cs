...
public class KS5EstablishmentPerformance
{
    ...
    // Tech level Average result points for the school / college - Current
    ...
    // Number of students for establishment - Disadvantaged - Academic qualifications
    public CodedDouble TALLPUP_ACAD_1618_DIS_Est_Current_Num_Coded { get; set; }

    // Progress score for establishment - Disadvantaged - Academic qualifications
    public CodedDouble VA_INS_ACAD_DIS_Est_Current_Num_Coded { get; set; }

    // Progress confidence interval for establishment upper - Disadvantaged - Academic qualifications
    public CodedDouble UCI_INS_ACAD_DIS_Est_Current_Num_Coded { get; set; }

    // Progress confidence interval for establishment lower - Disadvantaged - Academic qualifications
    public CodedDouble LCI_INS_ACAD_DIS_Est_Current_Num_Coded { get; set; }

    // Grade for establishment - Disadvantaged - Academic qualifications
    public CodedString TALLPPEGRD_ACAD_DIS_Est_Current { get; set; }
    ...
    // Number of students for establishment - Disadvantaged - Tech Levels
    public CodedDouble TALLPUP_TLEV_DIS_Est_Current_Num_Coded { get; set; }

    // Progress score for establishment - Disadvantaged - Tech Levels
    public CodedDouble VA_INS_TLEV_DIS_Est_Current_Num_Coded { get; set; }

    // Progress confidence interval for establishment upper - Disadvantaged - Tech Levels
    public CodedDouble UCI_INS_TLEV_DIS_Est_Current_Num_Coded { get; set; }

    // Progress confidence interval for establishment lower - Disadvantaged - Tech Levels
    public CodedDouble LCI_INS_TLEV_DIS_Est_Current_Num_Coded { get; set; }

    // Grade for establishment - Disadvantaged - Tech Levels
    public CodedString TALLPPEGRD_TLEV_DIS_Est_Current { get; set; }

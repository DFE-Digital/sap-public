    ...
    public class OverviewService(IOverviewRepository overviewRepository) : IOverviewService
    {
            ...
            CancellationToken ct = default)
        {
            ...
            return new OverviewModel
            {
                ...
                GcseSubjectsEntered = overview.KS4Performance?.GCSESubjectEnteredSum_Est_Current_Num_Coded,
                TechnicalSubjectsEntered = overview.KS4Performance?.TechSubjectEnteredSum_Est_Current_Num_Coded,
                TopTechnicalSubjects = overview.TopTechnicalSubjects.Select(x => new TechnicalSubjectModel { SubjectName = x.SubjectName, PercentageEntering = x.PercentageEntering}).ToList(),

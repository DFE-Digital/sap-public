...
{
    public class TESTablishmentService(
        ITESTablishmentRepository establishmentRepository,
        ILookupService lookUpService) : ITESTablishmentService
    {
        private readonly ITESTablishmentRepository _establishmentRepository = establishmentRepository;
